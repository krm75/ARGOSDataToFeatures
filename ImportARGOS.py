...
## ../ indicates that code chould step outside of project folder then continue
inputFolder = '../Data/ARGOSData'
inputFiles = os.listdir(inputFolder)
outputFC = '../Scratch/ARGOStrack2.shp'
...
#iterate through each file in the ARGOS directory
